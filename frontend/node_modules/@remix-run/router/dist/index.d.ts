...
export { AbortedDeferredError, data as unstable_data, defer, generatePath, getToPathname, isRouteErrorResponse, joinPaths, json, matchPath, matchRoutes, normalizePathname, redirect, redirectDocument, replace, resolvePath, resolveTo, stripBasename, } from "@remix-run/router/dist/utils";
...
export { Action, createBrowserHistory, createHashHistory, createMemoryHistory, createPath, parsePath, } from "@remix-run/router/dist/history";
